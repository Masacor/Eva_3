...
def admin_usuarios(request):
    return render(request, 'core/mantenedor_user.html')
...
def boleta(request, nro_boleta):
    ...
    return render(request, 'core/detalleboleta.html', datos)
...
def ficha(request, producto_id):
    ...
    return render(request, 'core/fichaproducto.html', context)
...
def admin_productos(request, accion, id):
    ...
    return render(request, 'core/mantenedor_prod.html', datos)


def premio(request):
    return render(request, 'core/api-ropa.html')
